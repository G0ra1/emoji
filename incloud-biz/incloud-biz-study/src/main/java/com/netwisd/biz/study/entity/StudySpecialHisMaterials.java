 ...
 */
@Data
@Table(value = "incloud_biz_study_special_his_materials",comment = "专题历史与学习资料表")
@TableName("incloud_biz_study_special_his_materials")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题历史与学习资料表 Entity")
public class StudySpecialHisMaterials extends IModel<StudySpecialHisMaterials> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_study_special_his" ,fkFieldName = "id" , isNull = true, comment = "计划id")
