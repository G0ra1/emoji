 ...
 */
@Data
@Map("incloud_biz_study_special_adj_lesson")
@ApiModel(value = "专题调整与课程表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialAdjLessonDto extends IDto{

    public StudySpecialAdjLessonDto(Args args){
        super(args);
    }
    /**
     * special_id
    ...
    private List<StudySpecialAdjLessonCouDto> studySpecialLessonCouList;
