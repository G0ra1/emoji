 ...
 */
@Data
@Table(value = "incloud_biz_study_exam_paper",comment = "试卷结果表")
@TableName("incloud_biz_study_exam_paper")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "试卷结果表 Entity")
public class StudyExamPaper extends WfEntity<StudyExamPaper> {
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "单选题数量")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "多选题数量")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "填空题数量")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "判断题数量")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "简答题数量")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "是否启用 0禁用,1启用")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 2,  isNull = true, comment = "考试时长")
