 ...
 */
@Data
@Table(value = "incloud_biz_study_special_adj_jieye",comment = "专题调整与结业设置（子表）")
@TableName("incloud_biz_study_special_adj_jieye")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题调整与结业设置（子表） Entity")
public class StudySpecialAdjJieye extends IModel<StudySpecialAdjJieye> {
