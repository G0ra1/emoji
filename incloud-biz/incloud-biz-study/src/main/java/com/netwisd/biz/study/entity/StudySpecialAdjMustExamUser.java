 ...
 */
@Data
@Table(value = "incloud_biz_study_special_adj_must_exam_user",comment = "专题调整必考人员")
@TableName("incloud_biz_study_special_adj_must_exam_user")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题调整必考人员 Entity")
public class StudySpecialAdjMustExamUser extends IModel<StudySpecialAdjMustExamUser> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_study_special_adj" ,fkFieldName = "id" , isNull = true, comment = "专题id")
