 ...
 */
@Data
@Table(value = "incloud_biz_study_exam_paper_question",comment = "试卷和题目结果")
@TableName("incloud_biz_study_exam_paper_question")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "试卷和题目结果 Entity")
public class StudyExamPaperQuestion extends IModel<StudyExamPaperQuestion> {
    ...
    */
    ...
    @Column(type = DataType.INT, length = 11,  isNull = true, comment = "题目类型;0单选题，1多选题，2填空题，3判断题，4简答题")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 11,  isNull = true, comment = "题目难度;0易，1中，2难")
