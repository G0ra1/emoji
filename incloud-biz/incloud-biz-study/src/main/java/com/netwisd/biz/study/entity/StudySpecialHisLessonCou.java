 ...
 */
@Data
@Table(value = "incloud_biz_study_special_his_lesson_cou",comment = "专题历史课程与课件表")
@TableName("incloud_biz_study_special_his_lesson_cou")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题历史课程与课件表 Entity")
public class StudySpecialHisLessonCou extends IModel<StudySpecialHisLessonCou> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_study_special_his_lesson" ,fkFieldName = "id" , isNull = true, comment = "专题课程表id")
