 ...
 */
@Data
@Map("incloud_biz_study_special_adj_materials")
@ApiModel(value = "专题调整与学习资料表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialAdjMaterialsDto extends IDto{

    public StudySpecialAdjMaterialsDto(Args args){
        super(args);
    }
    /**
     * special_id
