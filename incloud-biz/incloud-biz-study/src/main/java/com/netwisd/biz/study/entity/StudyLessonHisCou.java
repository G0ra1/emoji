 ...
 */
@Data
@Table(value = "incloud_biz_study_lesson_his_cou", comment = "课程历史课件")
@TableName("incloud_biz_study_lesson_his_cou")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "课程历史课件 Entity")
public class StudyLessonHisCou extends IModel<StudyLessonHisCou> {
