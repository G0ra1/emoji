 ...
 */
@Data
@Table(value = "incloud_biz_study_special_range",comment = "专题与对象表")
@TableName("incloud_biz_study_special_range")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题与对象表 Entity")
public class StudySpecialRange extends IModel<StudySpecialRange> {
