 ...
 */
@Data
@Map("incloud_biz_study_special_materials")
@ApiModel(value = "专题与学习资料表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialMaterialsDto extends IDto{

    public StudySpecialMaterialsDto(Args args){
        super(args);
    }
    /**
     * special_id
