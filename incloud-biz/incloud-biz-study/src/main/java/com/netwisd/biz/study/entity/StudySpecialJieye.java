 ...
 */
@Data
@Table(value = "incloud_biz_study_special_jieye",comment = "专题结业设置（子表）;证书")
@TableName("incloud_biz_study_special_jieye")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题结业设置（子表）;证书 Entity")
public class StudySpecialJieye extends IModel<StudySpecialJieye> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_study_special" ,fkFieldName = "id" , isNull = true, comment = "专题id")
