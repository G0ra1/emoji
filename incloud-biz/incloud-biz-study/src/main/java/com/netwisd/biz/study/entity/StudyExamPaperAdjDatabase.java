 ...
 */
@Data
@Table(value = "incloud_biz_study_exam_paper_adj_database",comment = "试卷调整题库")
@TableName("incloud_biz_study_exam_paper_adj_database")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "试卷调整题库 Entity")
public class StudyExamPaperAdjDatabase extends IModel<StudyExamPaperAdjDatabase> {
