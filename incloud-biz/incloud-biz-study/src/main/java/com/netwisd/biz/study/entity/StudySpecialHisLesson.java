 ...
 */
@Data
@Table(value = "incloud_biz_study_special_his_lesson",comment = "专题历史与课程表")
@TableName("incloud_biz_study_special_his_lesson")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题历史与课程表 Entity")
public class StudySpecialHisLesson extends IModel<StudySpecialHisLesson> {
