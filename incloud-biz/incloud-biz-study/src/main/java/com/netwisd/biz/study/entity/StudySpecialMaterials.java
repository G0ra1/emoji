 ...
 */
@Data
@Table(value = "incloud_biz_study_special_materials",comment = "专题与学习资料表")
@TableName("incloud_biz_study_special_materials")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题与学习资料表 Entity")
public class StudySpecialMaterials extends IModel<StudySpecialMaterials> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_study_special" ,fkFieldName = "id" , isNull = true, comment = "计划id")
