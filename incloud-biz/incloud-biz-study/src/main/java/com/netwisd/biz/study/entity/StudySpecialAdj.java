 ...
 */
@Data
@Table(value = "incloud_biz_study_special_adj",comment = "专题调整申请表")
@TableName("incloud_biz_study_special_adj")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题调整申请表 Entity")
public class StudySpecialAdj extends WfEntity<StudySpecialAdj> {
