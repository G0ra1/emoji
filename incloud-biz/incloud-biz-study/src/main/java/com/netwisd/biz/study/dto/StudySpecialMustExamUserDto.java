 ...
 */
@Data
@Map("incloud_biz_study_special_must_exam_user")
@ApiModel(value = "专题必考人员 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialMustExamUserDto extends IDto{

    public StudySpecialMustExamUserDto(Args args){
        super(args);
    }
    /**
     * create_user_id
