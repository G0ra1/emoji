package com.netwisd.biz.study.config;
...
public class SwaggerConfig {
	...
	public Docket docket() {
		return new Docket(DocumentationType.SWAGGER_2)
				.groupName("在线学习系统swagger接口文档")
				.apiInfo(apiInfo())
				.select()
				.apis(basePackage("com.netwisd.biz.study"))
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("接口文档")
				.description("中原建设在线学习系统接口文档。")
				.contact(new Contact("zhangyan",
						"https://www.netwisd.com",
