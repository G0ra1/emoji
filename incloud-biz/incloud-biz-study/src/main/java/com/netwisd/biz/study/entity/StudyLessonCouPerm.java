 ...
 */
@Data
@Table(value = "incloud_biz_study_lesson_cou_perm",comment = "课程课件授权表")
@TableName("incloud_biz_study_lesson_cou_perm")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "课程课件授权表 Entity")
public class StudyLessonCouPerm extends IModel<StudyLessonCouPerm> {
