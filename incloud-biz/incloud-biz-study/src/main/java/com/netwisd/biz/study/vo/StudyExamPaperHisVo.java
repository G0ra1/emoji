 ...
 */
@Data
@ApiModel(value = "试卷历史 Vo")
public class StudyExamPaperHisVo extends IVo{
    ...
    private List<StudyExamPaperHisDatabaseVo> studyExamPaperApplyDatabaseList;
    @ApiModelProperty(value="studyExamPaperHisQuestionList")
    private List<StudyExamPaperHisQuestionVo> studyExamPaperApplyQuestionList;
