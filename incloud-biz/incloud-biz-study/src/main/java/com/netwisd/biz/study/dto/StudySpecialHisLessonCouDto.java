 ...
 */
@Data
@Map("incloud_biz_study_special_his_lesson_cou")
@ApiModel(value = "专题历史课程与课件表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialHisLessonCouDto extends IDto{

    public StudySpecialHisLessonCouDto(Args args){
        super(args);
    }
    /**
     * special_lesson_id
    ...
    @Fk(table = "incloud_biz_study_special_his_lesson" ,field = "id")
