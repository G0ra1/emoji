 ...
 */
@Data
@Map("incloud_biz_study_special_adj_must_exam_user")
@ApiModel(value = "专题调整必考人员 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialAdjMustExamUserDto extends IDto{

    public StudySpecialAdjMustExamUserDto(Args args){
        super(args);
    }
    /**
     * create_user_id
