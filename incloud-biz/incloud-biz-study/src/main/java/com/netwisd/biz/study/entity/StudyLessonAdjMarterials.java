 ...
 */
@Data
@Table(value = "incloud_biz_study_lesson_adj_marterials", comment = "课程调整学习资料")
@TableName("incloud_biz_study_lesson_adj_marterials")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "课程调整学习资料 Entity")
public class StudyLessonAdjMarterials extends IModel<StudyLessonAdjMarterials> {
