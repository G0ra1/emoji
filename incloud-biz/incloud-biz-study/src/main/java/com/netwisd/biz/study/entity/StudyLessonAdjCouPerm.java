 ...
 */
@Data
@Table(value = "incloud_biz_study_lesson_adj_cou_perm",comment = "课程课件授权调整表")
@TableName("incloud_biz_study_lesson_adj_cou_perm")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "课程课件授权调整表 Entity")
public class StudyLessonAdjCouPerm extends IModel<StudyLessonAdjCouPerm> {
