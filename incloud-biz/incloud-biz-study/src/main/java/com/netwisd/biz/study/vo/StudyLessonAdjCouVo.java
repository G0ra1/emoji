 ...
 */
@Data
@ApiModel(value = "课程调整课件 Vo")
public class StudyLessonAdjCouVo extends IVo {
    ...
    private List<StudyLessonAdjCouPermVo> orgPermList;
    /**
     * userPermList
     * 课程课件人员授权
     */
    @ApiModelProperty(value = "课程课件人员授权")
    private List<StudyLessonAdjCouPermVo> userPermList;
}
