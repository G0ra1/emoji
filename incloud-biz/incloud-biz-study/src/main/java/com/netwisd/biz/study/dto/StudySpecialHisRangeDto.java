 ...
 */
@Data
@Map("incloud_biz_study_special_his_range")
@ApiModel(value = "专题历史与对象表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialHisRangeDto extends IDto{

    public StudySpecialHisRangeDto(Args args){
        super(args);
    }
    /**
     * special_id
