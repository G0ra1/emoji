 ...
 */
@Data
@Map("incloud_biz_study_special_lesson_cou")
@ApiModel(value = "专题课程与课件表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialLessonCouDto extends IDto{

    public StudySpecialLessonCouDto(Args args){
        super(args);
    }
    /**
     * special_lesson_id
    ...
    @Fk(table = "incloud_biz_study_special_lesson" ,field = "id")
