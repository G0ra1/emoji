 ...
 */
@Data
@ApiModel(value = "课程课件表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudyLessonCouDto extends IDto {
    ...
    private List<StudyLessonCouPermDto> orgPermList;
    ...
    private List<StudyLessonCouPermDto> userPermList;
