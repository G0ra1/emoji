 ...
 */
@Data
@Map("incloud_biz_study_special_lesson")
@ApiModel(value = "专题与课程中间表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialLessonDto extends IDto{

    public StudySpecialLessonDto(Args args){
        super(args);
    }
    /**
     * special_id
    ...
    private List<StudySpecialLessonCouDto> studySpecialLessonCouList;
}
