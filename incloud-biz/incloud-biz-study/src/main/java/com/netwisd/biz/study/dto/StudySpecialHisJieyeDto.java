 ...
 */
@Data
@Map("incloud_biz_study_special_his_jieye")
@ApiModel(value = "专题历史与结业设置（子表） Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialHisJieyeDto extends IDto{

    public StudySpecialHisJieyeDto(Args args){
        super(args);
    }
    /**
     * special_id
