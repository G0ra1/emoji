 ...
 */
@Data
@Table(value = "incloud_biz_study_special_must_exam_user",comment = "专题必考人员")
@TableName("incloud_biz_study_special_must_exam_user")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题必考人员 Entity")
public class StudySpecialMustExamUser extends IModel<StudySpecialMustExamUser> {
    ...
    @Column(type = DataType.BIGINT, length = 20, fkTableName = "incloud_biz_study_special" ,fkFieldName = "id" , isNull = true, comment = "专题id")
    ...
    @Column(type = DataType.BIGINT, length = 20,  isNull = true, comment = "专题试卷id")
    ...
    @Column(type = DataType.BIGINT, length = 20,  isNull = true, comment = "专题必考人员id")
