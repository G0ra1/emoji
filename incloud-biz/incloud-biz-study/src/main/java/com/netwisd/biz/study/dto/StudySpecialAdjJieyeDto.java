 ...
 */
@Data
@Map("incloud_biz_study_special_adj_jieye")
@ApiModel(value = "专题调整与结业设置（子表） Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class StudySpecialAdjJieyeDto extends IDto{

    public StudySpecialAdjJieyeDto(Args args){
        super(args);
    }
    /**
     * special_id
