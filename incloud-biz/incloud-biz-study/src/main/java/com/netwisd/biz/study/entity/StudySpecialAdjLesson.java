 ...
 */
@Data
@Table(value = "incloud_biz_study_special_adj_lesson",comment = "专题调整与课程表")
@TableName("incloud_biz_study_special_adj_lesson")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "专题调整与课程表 Entity")
public class StudySpecialAdjLesson extends IModel<StudySpecialAdjLesson> {
