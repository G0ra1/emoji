 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_change",comment = "资产信息变更")
@TableName("incloud_biz_asset_material_change")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产信息变更 Entity")
public class MaterialChange extends IModel<MaterialChange> {
