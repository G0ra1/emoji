 ...
 */
@Data
@Map("incloud_biz_asset_material_storage")
@ApiModel(value = "资产入库管理 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialStorageDto extends WfDto{

    public MaterialStorageDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="materialStorageDetailList")
    private List<MaterialStorageDetailDto> materialStorageDetailList;
