 ...
 */
@Data
@Table(value = "incloud_biz_asset_supplies",comment = "耗材库存台账")
@TableName("incloud_biz_asset_supplies")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "耗材库存台账 Entity")
public class Supplies extends IModel<Supplies> {
