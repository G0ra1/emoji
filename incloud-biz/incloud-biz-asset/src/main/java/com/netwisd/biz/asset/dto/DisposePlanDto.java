 ...
 */
@Data
@Map("incloud_biz_asset_dispose_plan")
@ApiModel(value = "处置计划 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class DisposePlanDto extends IDto{

    public DisposePlanDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="disposePlanDetailList")
    private List<DisposePlanDetailDto> disposePlanDetailList;
