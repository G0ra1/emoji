 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_refund",comment = "资产退还")
@TableName("incloud_biz_asset_material_refund")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产退还 Entity")
public class MaterialRefund extends WfEntity<MaterialRefund> {
