 ...
 */
@Data
@Map("incloud_biz_asset_purchase_register")
@ApiModel(value = "采购信息登记 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class PurchaseRegisterDto extends IDto{

    public PurchaseRegisterDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="purchaseRegisterAssetsList")
    private List<PurchaseRegisterAssetsDto> assetsList;
    @ApiModelProperty(value="purchaseRegisterDetailList")
    private List<PurchaseRegisterDetailDto> detailList;
