 ...
 */
@Data
@Map("incloud_biz_asset_scrap_apply_detail")
@ApiModel(value = "报废申请详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class ScrapApplyDetailDto extends IDto{

    public ScrapApplyDetailDto(Args args){
        super(args);
    }
    /**
     * apply_id
    ...
    @Fk(table = "incloud_biz_asset_scrap_apply" ,field = "id")
