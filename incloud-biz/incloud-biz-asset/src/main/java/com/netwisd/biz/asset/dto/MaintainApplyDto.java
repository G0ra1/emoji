 ...
 */
@Data
@Map("incloud_biz_asset_maintain_apply")
@ApiModel(value = "维修申请 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaintainApplyDto extends WfDto {

    public MaintainApplyDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="maintainApplyDetailList")
    private List<MaintainApplyDetailDto> maintainApplyDetailList;
