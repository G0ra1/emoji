 ...
 */
@Data
@Map("incloud_biz_asset_maintain_plan")
@ApiModel(value = "维修计划 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaintainPlanDto extends WfDto {

    public MaintainPlanDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="maintainPlanDetailList")
    private List<MaintainPlanDetailDto> maintainPlanDetailList;
