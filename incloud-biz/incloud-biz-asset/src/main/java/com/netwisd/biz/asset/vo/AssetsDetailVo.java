 ...
 */
@Data
@ApiModel(value = "资产明细 Vo")
public class AssetsDetailVo extends IVo{
     ...
     */
    @JsonSerialize(using = IdTypeSerializer.class)
    @ApiModelProperty(value="资产所属人部门")
    private Long assetUserDeptId;
    /**
     * asset_user_dept_name
     * 使用人单位
     */
    @ApiModelProperty(value="资产所属部门")
    private String assetUserDeptName;
    /**
     * asset_user_org_id
     * 使用人单位
     */
    @JsonSerialize(using = IdTypeSerializer.class)
    @ApiModelProperty(value="资产所属单位")
    private Long assetUserOrgId;
    /**
     * asset_user_org_name
     * 使用人单位
     */
    @ApiModelProperty(value="资产所属单位")
    private String assetUserOrgName;
    /**
     * register_user_id
     * 采购登记人
     */
    ...
    private SuppliesDetailVo suppliesDetailVo;
