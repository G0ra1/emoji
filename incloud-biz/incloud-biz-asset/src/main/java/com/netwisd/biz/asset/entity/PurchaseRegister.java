 ...
 */
@Data
@Table(value = "incloud_biz_asset_purchase_register",comment = "采购信息登记")
@TableName("incloud_biz_asset_purchase_register")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "采购信息登记 Entity")
public class PurchaseRegister extends WfEntity<PurchaseRegister> {
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "购置申请id;购置申请id")
    ...
    @TableField(value="contract_file_name")
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "采购合同附件名称")
    ...
    /**
     * not_acceptance_amount
     * 未验收金额
     */
    @ApiModelProperty(value="未验收金额")
    @TableField(value="not_acceptance_amount")
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "未验收金额")
    private BigDecimal notAcceptanceAmount;
    /**
     * acceptance_number
     * 验收数量
     */
