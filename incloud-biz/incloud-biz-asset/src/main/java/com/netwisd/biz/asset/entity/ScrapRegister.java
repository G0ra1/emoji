 ...
 */
@Data
@Table(value = "incloud_biz_asset_scrap_register",comment = "报废登记")
@TableName("incloud_biz_asset_scrap_register")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "报废登记 Entity")
public class ScrapRegister extends WfEntity<ScrapRegister> {
    ...
    @Column(type = DataType.VARCHAR, length = 2000,  isNull = true, comment = "申请人父级组织全路径ID")
    private String applyUserOrgFullId;
    /**
     * apply_code
     * 报废申请编号
     */
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "报废申请编号")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "报废申请id")
