 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_plan",comment = "维修计划")
@TableName("incloud_biz_asset_maintain_plan")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修计划 Entity")
public class MaintainPlan extends WfEntity<MaintainPlan> {
