 ...
 */
@Data
@Map("incloud_biz_asset_supplies")
@ApiModel(value = "耗材库存台账 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class SuppliesDto extends IDto{

    public SuppliesDto(Args args){
        super(args);
    }
    /**
     * asset_org_id
    ...
    @ApiModelProperty(value="suppliesSkuList")
    private List<SuppliesSkuDto> suppliesSkuList;
