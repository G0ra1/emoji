 ...
 */
@Data
@Table(value = "incloud_biz_asset_inventory",comment = "物资盘点")
@TableName("incloud_biz_asset_inventory")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "物资盘点 Entity")
public class Inventory extends WfEntity<Inventory> {
    ...
    @TableField(value="inventory_year")
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "盘点年度")
