 ...
 */
@Data
@Table(value = "incloud_biz_asset_assets_detail",comment = "资产明细")
@TableName("incloud_biz_asset_assets_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产明细 Entity")
public class AssetsDetail extends IModel<AssetsDetail> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_assets" ,fkFieldName = "id" , isNull = true, comment = "资产id")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "订单编号")
    ...
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "使用人ID")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "使用人名称")
