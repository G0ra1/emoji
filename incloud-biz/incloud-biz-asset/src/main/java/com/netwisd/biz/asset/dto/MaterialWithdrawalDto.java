 ...
 */
@Data
@Map("incloud_biz_asset_material_withdrawal")
@ApiModel(value = "资产退库 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialWithdrawalDto extends WfDto {

    public MaterialWithdrawalDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    @ApiModelProperty(value="materialWithdrawalDetailList")
    private List<MaterialWithdrawalDetailDto> materialWithdrawalDetailList;
