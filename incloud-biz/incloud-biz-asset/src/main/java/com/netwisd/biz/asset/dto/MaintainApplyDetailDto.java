 ...
 */
@Data
@Map("incloud_biz_asset_maintain_apply_detail")
@ApiModel(value = "维修申请详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaintainApplyDetailDto extends IDto{

    public MaintainApplyDetailDto(Args args){
        super(args);
    }
    /**
     * maintain_apply_id
    ...
    @Fk(table = "incloud_biz_asset_maintain_apply" ,field = "id")
