 ...
 */
@Data
@Map("incloud_biz_asset_material_distribute_assets")
@ApiModel(value = "资产派发明细 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialDistributeAssetsDto extends IDto{

    public MaterialDistributeAssetsDto(Args args){
        super(args);
    }
    /**
     * distribute_id
