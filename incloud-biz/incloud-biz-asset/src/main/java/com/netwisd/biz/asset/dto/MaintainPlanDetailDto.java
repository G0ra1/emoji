 ...
 */
@Data
@Map("incloud_biz_asset_maintain_plan_detail")
@ApiModel(value = "维修计划明细 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaintainPlanDetailDto extends IDto{

    public MaintainPlanDetailDto(Args args){
        super(args);
    }
    /**
     * maintain_plan_id
    ...
    @Fk(table = "incloud_biz_asset_maintain_plan" ,field = "id")
