 ...
 */
@Data
@Map("incloud_biz_asset_material_accept_detail")
@ApiModel(value = "资产领用明细详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialAcceptDetailDto extends IDto{

    public MaterialAcceptDetailDto(Args args){
        super(args);
    }
    /**
     * accept_id
     ...
     */
    @JsonDeserialize(using = IdTypeDeserializer.class)
    @Fk(table = "incloud_biz_asset_maint_accept_assets" ,field = "id")
