 ...
 */
@Data
@Table(value = "incloud_biz_asset_scrap_register_detail",comment = "报废登记详情")
@TableName("incloud_biz_asset_scrap_register_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "报废登记详情 Entity")
public class ScrapRegisterDetail extends IModel<ScrapRegisterDetail> {

    /**
     * register_id
     * 报废登记id
     */
    @ApiModelProperty(value="报废登记id")
    @TableField(value="register_id")
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_scrap_register" ,fkFieldName = "id" , isNull = true, comment = "报废登记id")
    ...
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "报废申请id")
    private Long applyId;
    /**
     * apply_detail_id
     * 报废申请详情id
     */
    @ApiModelProperty(value="报废申请详情id")
    @TableField(value="apply_detail_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "报废申请详情id")
    ...
    @Column(type = DataType.DECIMAL, length = 10, precision = 2 , isNull = true, comment = "申请报废数量")
    ...
    @Column(type = DataType.DATE, length = 0,  isNull = true, comment = "报废时间")
