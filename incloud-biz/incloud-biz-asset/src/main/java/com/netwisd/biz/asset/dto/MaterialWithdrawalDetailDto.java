 ...
 */
@Data
@Map("incloud_biz_asset_material_withdrawal_detail")
@ApiModel(value = "资产退库详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialWithdrawalDetailDto extends IDto{

    public MaterialWithdrawalDetailDto(Args args){
        super(args);
    }
    /**
     * withdrawal_id
    ...
    @Fk(table = "incloud_biz_asset_material_withdrawal" ,field = "id")
