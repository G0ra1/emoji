 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_apply",comment = "维修申请")
@TableName("incloud_biz_asset_maintain_apply")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修申请 Entity")
public class MaintainApply extends WfEntity<MaintainApply> {
