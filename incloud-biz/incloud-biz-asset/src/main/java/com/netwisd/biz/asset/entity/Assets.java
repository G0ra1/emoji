 ...
 */
@Data
@Table(value = "incloud_biz_asset_assets",comment = "资产台账")
@TableName("incloud_biz_asset_assets")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产台账 Entity")
public class Assets extends IModel<Assets> {
