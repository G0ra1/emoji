 ...
 */
@Data
@Map("incloud_biz_asset_scrap_register")
@ApiModel(value = "报废登记 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class ScrapRegisterDto extends WfDto {

    public ScrapRegisterDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    private List<ScrapRegisterDetailDto> detailList;
