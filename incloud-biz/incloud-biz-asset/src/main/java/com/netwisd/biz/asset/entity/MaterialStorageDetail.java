 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_storage_detail",comment = "资产入库明细")
@TableName("incloud_biz_asset_material_storage_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产入库明细 Entity")
public class MaterialStorageDetail extends IModel<MaterialStorageDetail> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_maint_storage" ,fkFieldName = "id" , isNull = true, comment = "资产入库id")
