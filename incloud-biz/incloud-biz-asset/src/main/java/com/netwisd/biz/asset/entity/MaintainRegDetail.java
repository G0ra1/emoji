 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_reg_detail",comment = "维修登记详情表")
@TableName("incloud_biz_asset_maintain_reg_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修登记详情表 Entity")
public class MaintainRegDetail extends IModel<MaintainRegDetail> {
    ...
    @TableField(value="maintain_reg_id")
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_maintain_reg" ,fkFieldName = "id" , isNull = true, comment = "维修登记id")
    private Long maintainRegId;
    /**
     * assets_id
     * 资产Id
     */
     ...
     * 使用配件数量
     */
    @ApiModelProperty(value="使用配件数量")
    @TableField(value="fitting_number")
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "使用配件数量")
    private BigDecimal fittingNumber;
    /**
     * purchase_amount
     * 购置单价
     */
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "申请单位id")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "申请单位名称")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "申请部门id")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "申请部门名称")
