 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_assets_result",comment = "维修资产明细")
@TableName("incloud_biz_asset_maintain_assets_result")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修资产明细 Entity")
public class MaintainAssetsResult extends IModel<MaintainAssetsResult> {
    ...
    */
    ...
    @TableField(value="maintain_plan_code")
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "维修计划编码")
    ...
    */
    ...
    @TableField(value="maintain_plan_data")
    @Column(type = DataType.DATETIME, length = 0,  isNull = true, comment = "维修计划日期")
    ...
    */
    ...
    @Column(type = DataType.INT, length = 10,  isNull = true, comment = "维修状态")
    ...
    */
    ...
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "计划年度")
