 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_plan_detail",comment = "维修计划明细")
@TableName("incloud_biz_asset_maintain_plan_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修计划明细 Entity")
public class MaintainPlanDetail extends IModel<MaintainPlanDetail> {
    ...
    @TableField(value="maintain_plan_id")
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_maintain_plan" ,fkFieldName = "id" , isNull = true, comment = "维修计划id")
