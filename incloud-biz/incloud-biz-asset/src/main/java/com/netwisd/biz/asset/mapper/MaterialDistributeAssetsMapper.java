 ...
 */
@Mapper
public interface MaterialDistributeAssetsMapper extends BaseMapper<MaterialDistributeAssets> {
    /**
     ...
     * @return
     */
    Page<MaterialDistributeAssetsVo> getPageList(Page page, @Param("materialDistributeAssetsDto") MaterialDistributeAssetsDto materialDistributeAssetsDto);
}
