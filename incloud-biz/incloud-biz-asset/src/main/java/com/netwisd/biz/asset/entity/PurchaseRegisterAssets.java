 ...
 */
@Data
@Table(value = "incloud_biz_asset_purchase_register_assets",comment = "采购信息登记明细")
@TableName("incloud_biz_asset_purchase_register_assets")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "采购信息登记明细 Entity")
public class PurchaseRegisterAssets extends IModel<PurchaseRegisterAssets> {
    ...
    @Column(type = DataType.VARCHAR, length = 2000,  isNull = true, comment = "子集编码拼接")
