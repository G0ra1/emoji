 ...
 */
@Data
@Map("incloud_biz_asset_material_storage_detail")
@ApiModel(value = "资产入库明细 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialStorageDetailDto extends IDto{

    public MaterialStorageDetailDto(Args args){
        super(args);
    }
    /**
     * storage_id
    ...
    @Fk(table = "incloud_biz_asset_maint_storage" ,field = "id")
