 ...
 */
@Data
@Table(value = "incloud_biz_asset_maintain_reg",comment = "维修登记")
@TableName("incloud_biz_asset_maintain_reg")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "维修登记 Entity")
public class MaintainReg extends WfEntity<MaintainReg> {
    ...
    @TableField(value="maintain_apply_detail_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "维修申请id")
    ...
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "资产名称")
    ...
    @Column(type = DataType.DATETIME, length = 0,  isNull = true, comment = "维修时间")
    ...
    @TableField(value="maintain_number")
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "维修数量")
    ...
    @TableField(value="maintain_amount")
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "维修费用")
    ...
    @TableField(value="maintain_items")
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "维修方式")
