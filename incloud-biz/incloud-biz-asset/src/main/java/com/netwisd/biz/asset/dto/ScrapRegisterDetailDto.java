 ...
 */
@Data
@Map("incloud_biz_asset_scrap_register_detail")
@ApiModel(value = "报废登记详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class ScrapRegisterDetailDto extends IDto{

    public ScrapRegisterDetailDto(Args args){
        super(args);
    }
    /**
     * register_id
    ...
    @Fk(table = "incloud_biz_asset_scrap_register" ,field = "id")
