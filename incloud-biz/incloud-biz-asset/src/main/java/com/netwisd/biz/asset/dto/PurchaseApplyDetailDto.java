 ...
 */
@Data
@Map("incloud_biz_asset_purchase_apply_detail")
@ApiModel(value = "购置申请详情 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class PurchaseApplyDetailDto extends IDto{

    public PurchaseApplyDetailDto(Args args){
        super(args);
    }
    /**
     * apply_id
    ...
    @Fk(table = "incloud_biz_asset_purchase_apply" ,field = "id")
