 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_deploy_detail",comment = "资产调配明细")
@TableName("incloud_biz_asset_material_deploy_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产调配明细 Entity")
public class MaterialDeployDetail extends IModel<MaterialDeployDetail> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_material_deploy" ,fkFieldName = "id" , isNull = true, comment = "资产调配id")
