 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_withdrawal",comment = "资产退库")
@TableName("incloud_biz_asset_material_withdrawal")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产退库 Entity")
public class MaterialWithdrawal extends WfEntity<MaterialWithdrawal> {
