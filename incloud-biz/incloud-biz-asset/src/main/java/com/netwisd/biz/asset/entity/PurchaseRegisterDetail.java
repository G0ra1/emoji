 ...
 */
@Data
@Table(value = "incloud_biz_asset_purchase_register_detail",comment = "采购信息登记详情")
@TableName("incloud_biz_asset_purchase_register_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "采购信息登记详情 Entity")
public class PurchaseRegisterDetail extends IModel<PurchaseRegisterDetail> {
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "申请税率")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "申请税额")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购税率")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购税额")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购含税单价")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购不含税单价")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购含税总价")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购不含税总价")
    ...
    @Column(type = DataType.DATETIME, length = 0,  isNull = true, comment = "要求到货时间")
    ...
    @Column(type = DataType.DATETIME, length = 0,  isNull = true, comment = "预计到货时间")
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_purchase_register" ,fkFieldName = "id" , isNull = true, comment = "采购登记id")
    ...
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "采购登记明细id")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "采购总税额")
