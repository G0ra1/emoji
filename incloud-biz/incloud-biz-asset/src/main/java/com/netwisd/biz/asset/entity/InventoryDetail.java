 ...
 */
@Data
@Table(value = "incloud_biz_asset_inventory_detail",comment = "盘点详情")
@TableName("incloud_biz_asset_inventory_detail")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "盘点详情 Entity")
public class InventoryDetail extends IModel<InventoryDetail> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_inventory" ,fkFieldName = "id" , isNull = true, comment = "盘点id")
    ...
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "验收时间")
    ...
    @TableField(value="paper_number")
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "账面数量")
    ...
    @Column(type = DataType.DECIMAL, length = 32, precision = 8 , isNull = true, comment = "实盘数量")
    ...
    @TableField(value="inventory_reason")
    @Column(type = DataType.VARCHAR, length = 500,  isNull = true, comment = "盘点说明")
