 ...
 */
@Data
@Map("incloud_biz_asset_purchase_register_assets")
@ApiModel(value = "采购信息登记明细 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class PurchaseRegisterAssetsDto extends IDto{

    public PurchaseRegisterAssetsDto(Args args){
        super(args);
    }
    /**
     * apply_id
