 ...
 */
@Data
@Table(value = "incloud_biz_asset_material_deploy_result",comment = "资产调配结果数据")
@TableName("incloud_biz_asset_material_deploy_result")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产调配结果数据 Entity")
public class MaterialDeployResult extends IModel<MaterialDeployResult> {
    ...
    */
    ...
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "调配id")
    ...
    */
    ...
    @TableField(value="deploy_code")
    @Column(type = DataType.VARCHAR, length = 255,  isNull = true, comment = "调配编码")
    ...
    */
    ...
    @TableField(value="deploy_detail_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "调配详情id")
    ...
    */
    ...
    @TableField(value="deploy_number")
    @Column(type = DataType.DECIMAL, length = 10, precision = 2 , isNull = true, comment = "调配数量")
    ...
    */
    ...
    @TableField(value="deploy_org_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "调配单位id")
    ...
    */
    ...
    @TableField(value="deploy_dept_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "调配部门id")
    ...
    */
    ...
    @TableField(value="deploy_user_id")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "调配负责人id")
    ...
    */
    ...
    @TableField(value="deploy_state")
    @Column(type = DataType.INT, length = 10,  isNull = true, comment = "调配状态")
    ...
    */
    ...
    @TableField(value="need_dept_name")
    @Column(type = DataType.BIGINT, length = 19,  isNull = true, comment = "需用部门")
    ...
    */
    ...
    @TableField(value="deploy_org_name")
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "调配单位")
    ...
    */
    ...
    @TableField(value="deploy_dept_name")
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "调配部门")
    ...
    */
    ...
    @TableField(value="deploy_user_name")
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "调配负责人")
