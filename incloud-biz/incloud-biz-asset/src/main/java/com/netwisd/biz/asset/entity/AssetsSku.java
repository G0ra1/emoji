 ...
 */
@Data
@Table(value = "incloud_biz_asset_assets_sku",comment = "资产sku信息")
@TableName("incloud_biz_asset_assets_sku")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "资产sku信息 Entity")
public class AssetsSku extends IModel<AssetsSku> {
    ...
    @Column(type = DataType.BIGINT, length = 19, fkTableName = "incloud_biz_asset_assets" ,fkFieldName = "id" , isNull = true, comment = "资产台账id")
