 ...
 */
@Data
@Map("incloud_biz_asset_material_distribute")
@ApiModel(value = "资产派发 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaterialDistributeDto extends IDto{

    public MaterialDistributeDto(Args args){
        super(args);
    }
    /**
     * code
    ...
    private List<MaterialDistributeDetailDto> detailList;
    @ApiModelProperty(value="派发详情")
    private List<MaterialDistributeAssetsDto> assetsList;
