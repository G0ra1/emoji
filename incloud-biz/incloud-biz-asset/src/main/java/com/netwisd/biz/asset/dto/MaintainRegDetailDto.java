 ...
 */
@Data
@Map("incloud_biz_asset_maintain_reg_detail")
@ApiModel(value = "维修登记详情表 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class MaintainRegDetailDto extends IDto{

    public MaintainRegDetailDto(Args args){
        super(args);
    }
    /**
     * maintain_reg_id
    ...
    @Fk(table = "incloud_biz_asset_maintain_reg" ,field = "id")
