 ...
 */
@Data
@ApiModel(value = "合同乙方 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class ContractPartybDto extends IDto{

    public ContractPartybDto(Args args){
        super(args);
    }
    ...
    private List<ContractPartybContactDto> partybContactList;
