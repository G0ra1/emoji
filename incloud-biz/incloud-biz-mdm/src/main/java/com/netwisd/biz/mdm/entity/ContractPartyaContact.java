 ...
 */
@Data
@Table(value = "incloud_biz_mdm_contract_partya_contact",comment = "甲方联系人")
@TableName("incloud_biz_mdm_contract_partya_contact")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "甲方联系人 Entity")
public class ContractPartyaContact extends IModel<ContractPartyaContact> {
