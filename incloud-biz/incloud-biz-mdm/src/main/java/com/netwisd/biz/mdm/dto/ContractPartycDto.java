 ...
 */
@Data
@ApiModel(value = "丙方 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class ContractPartycDto extends IDto{

    public ContractPartycDto(Args args){
        super(args);
    }
    ...
    private List<ContractPartycContactDto> partycContactList;
