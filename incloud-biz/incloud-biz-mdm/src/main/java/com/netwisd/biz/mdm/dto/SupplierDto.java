 ...
 */
@Data
@ApiModel(value = "供应商 Dto")
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode
public class SupplierDto extends IDto{

    public SupplierDto(Args args){
        super(args);
    }
    ...
    private List<SupplierBankDto> bankList;
    private List<SupplierContactsDto> contactsList;
