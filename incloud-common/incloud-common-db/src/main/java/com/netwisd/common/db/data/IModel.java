 ...
 */
@Data
public class IModel<T extends IModel<?>> extends Model<T> {
    /**
     * id
     * 主键
    ...
    @TableField(value = "create_user_parent_org_id", fill = FieldFill.INSERT)
    ...
    @TableField(value = "create_user_parent_org_name", fill = FieldFill.INSERT)
    ...
    @TableField(value = "create_user_parent_dept_id", fill = FieldFill.INSERT)
    ...
    @TableField(value = "create_user_parent_dept_name", fill = FieldFill.INSERT)
    ...
    @TableField(value = "create_user_org_full_id", fill = FieldFill.INSERT)
