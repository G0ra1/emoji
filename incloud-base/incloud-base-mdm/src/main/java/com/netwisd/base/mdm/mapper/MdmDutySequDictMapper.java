 ...
 */
@Mapper
public interface MdmDutySequDictMapper extends BaseMapper<MdmDutySequDict> {
    /**
     ...
     * @return
     */
    Page<MdmDutySequDictVo> getPageList(Page page, @Param("mdmDutySequDictDto") MdmDutySequDictDto mdmDutySequDictDto);
}
