 ...
 */
@Data
@Table(value = "incloud_base_mdm_duty_grade_dict",comment = "职务职等字典")
@TableName("incloud_base_mdm_duty_grade_dict")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "职务职等字典 Entity")
public class MdmDutyGradeDict extends IModel<MdmDutyGradeDict> {
