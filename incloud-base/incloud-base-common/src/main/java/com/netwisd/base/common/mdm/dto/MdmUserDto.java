...
@NoArgsConstructor
@EqualsAndHashCode
public class MdmUserDto extends IDto{

    public MdmUserDto(Args args){
        super(args);
    }
    /**
     * parent_org_id
    ...
    private MdmUserDetailDto mdmUserDetailDto;
    ...
    private MdmPostUserDto mdmPostUserDto;
    ...
    private MdmDutyUserDto mdmDutyUserDto;
     ...
     * 设置主职、兼职传的职位ids
     */
    @ApiModelProperty(value="设置主职、兼职传的职位ids")
    ...
    @ApiModelProperty(value="在线学习用户类型；0管理员，1讲师，2学员")
    private Integer studyUserRole;
    //===============================股份人员数据开始===================================
    /**
     * gf_hr_code
     * 人力人员编码
     ...
     * 员工状态
     */
    @ApiModelProperty(value="员工状态 1：在职人员，2：离职人员")
     ...
     * 是否在线学习学员角色 1是
     */
    @ApiModelProperty(value="是否在线学习学员角色 1是")
    private Integer isEduStudent;
