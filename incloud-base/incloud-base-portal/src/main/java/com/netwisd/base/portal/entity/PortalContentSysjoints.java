 ...
 */
@Data
@Table(value = "incloud_base_portal_content_sysjoints",comment = "系统集成类内容发布")
@TableName("incloud_base_portal_content_sysjoints")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "系统集成类内容发布 Entity")
public class PortalContentSysjoints extends IModel<PortalContentSysjoints> {
