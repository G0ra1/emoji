 ...
 */
@Data
@Table(value = "incloud_base_portal_content_pictures",comment = "图片轮播类内容发布")
@TableName("incloud_base_portal_content_pictures")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "图片轮播类内容发布 Entity")
public class PortalContentPictures extends IModel<PortalContentPictures> {
