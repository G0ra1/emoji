 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_banners", comment = "banner类内容-调整表")
@TableName("incloud_base_portal_content_adj_banners")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "banner类内容-调整表 Entity")
public class PortalContentAdjBanners extends WfEntity<PortalContentAdjBanners> {
