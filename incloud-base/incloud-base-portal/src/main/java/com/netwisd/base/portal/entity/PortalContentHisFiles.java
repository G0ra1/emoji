 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_files",comment = "历史 文件下载类型内容发布")
@TableName("incloud_base_portal_content_his_files")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "历史 文件下载类型内容发布 Entity")
public class PortalContentHisFiles extends IModel<PortalContentHisFiles> {
