 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_pictures",comment = "历史 图片轮播类内容发布")
@TableName("incloud_base_portal_content_his_pictures")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "历史 图片轮播类内容发布 Entity")
public class PortalContentHisPictures extends IModel<PortalContentHisPictures> {
