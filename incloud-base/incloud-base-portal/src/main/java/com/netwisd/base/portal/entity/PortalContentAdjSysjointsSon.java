 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_sysjoints_son",comment = "调整 系统集成类内容发布子表")
@TableName("incloud_base_portal_content_adj_sysjoints_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "调整 系统集成类内容发布子表 Entity")
public class PortalContentAdjSysjointsSon extends IModel<PortalContentAdjSysjointsSon> {
    ...
    @TableField(value="link_sysjoints_son_id")
    @Column(type = DataType.BIGINT, length = 20,  isNull = true, comment = "关联主数据子表对应id")
