 ...
 */
@Data
@Table(value = "incloud_base_portal_content_files",comment = "文件下载类型内容发布")
@TableName("incloud_base_portal_content_files")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "文件下载类型内容发布 Entity")
public class PortalContentFiles extends IModel<PortalContentFiles> {
