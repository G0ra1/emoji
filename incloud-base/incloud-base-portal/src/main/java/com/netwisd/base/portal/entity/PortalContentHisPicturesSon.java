 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_pictures_son",comment = "历史 图片轮播类内容发布子表")
@TableName("incloud_base_portal_content_his_pictures_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "历史 图片轮播类内容发布子表 Entity")
public class PortalContentHisPicturesSon extends IModel<PortalContentHisPicturesSon> {
