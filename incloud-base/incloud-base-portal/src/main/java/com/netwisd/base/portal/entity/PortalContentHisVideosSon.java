 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_videos_son",comment = " 视频类型内容发布-历史表子表 ")
@TableName("incloud_base_portal_content_his_videos_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = " 视频类型内容发布-历史表子表  Entity")
public class PortalContentHisVideosSon extends IModel<PortalContentHisVideosSon> {
