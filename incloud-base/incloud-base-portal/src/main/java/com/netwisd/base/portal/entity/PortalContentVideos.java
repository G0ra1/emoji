 ...
 */
@Data
@Table(value = "incloud_base_portal_content_videos",comment = " 视频类内容发布")
@TableName("incloud_base_portal_content_videos")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = " 视频类内容发布 Entity")
public class PortalContentVideos extends IModel<PortalContentVideos> {
