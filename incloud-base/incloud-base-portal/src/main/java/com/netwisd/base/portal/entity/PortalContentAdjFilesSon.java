 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_files_son",comment = "调整 文件下载类型内容发布子表")
@TableName("incloud_base_portal_content_adj_files_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "调整 文件下载类型内容发布子表 Entity")
public class PortalContentAdjFilesSon extends IModel<PortalContentAdjFilesSon> {
    ...
    @TableField(value="link_files_son_id")
