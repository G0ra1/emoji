 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_picnews",comment = "调整 图片新闻类内容发布")
@TableName("incloud_base_portal_content_adj_picnews")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "调整 图片新闻类内容发布 Entity")
public class PortalContentAdjPicnews extends WfEntity<PortalContentAdjPicnews> {
