 ...
 */
@Data
@Table(value = "incloud_base_portal_content_unread_tasks",comment = "任务集成类-待阅")
@TableName("incloud_base_portal_content_unread_tasks")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "任务集成类-待阅 Entity")
public class PortalContentUnreadTasks extends IModel<PortalContentUnreadTasks> {
     ...
     * 当前活动办理人ID
     */
    @ApiModelProperty(value="当前活动办理人ID")
    @TableField(value="handle_assignee_id_card")
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "当前活动办理人ID")
    ...
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "当前活动办理人名称")
