 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_videos",comment = " 视频类内容发布-调整表")
@TableName("incloud_base_portal_content_adj_videos")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = " 视频类内容发布-调整表 Entity")
public class PortalContentAdjVideos extends WfEntity<PortalContentAdjVideos> {
