 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_files_son",comment = "历史 文件下载类型内容发布子表")
@TableName("incloud_base_portal_content_his_files_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "历史 文件下载类型内容发布子表 Entity")
public class PortalContentHisFilesSon extends IModel<PortalContentHisFilesSon> {
