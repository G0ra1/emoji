 ...
 */
@Data
@Table(value = "incloud_base_portal_ybz_done_tasks",comment = "集成友报账-已办")
@TableName("incloud_base_portal_ybz_done_tasks")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "集成友报账-已办 Entity")
public class PortalYbzDoneTasks extends IModel<PortalYbzDoneTasks> {
