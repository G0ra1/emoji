 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_sysjoints",comment = "调整 系统集成类内容发布")
@TableName("incloud_base_portal_content_adj_sysjoints")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "调整 系统集成类内容发布 Entity")
public class PortalContentAdjSysjoints extends WfEntity<PortalContentAdjSysjoints> {
