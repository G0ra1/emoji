 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_videos_son",comment = " 视频类型内容发布-调整表子表  ")
@TableName("incloud_base_portal_content_adj_videos_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = " 视频类型内容发布-调整表子表   Entity")
public class PortalContentAdjVideosSon extends IModel<PortalContentAdjVideosSon> {
    ...
    @TableField(value="link_videos_son_id")
    @Column(type = DataType.BIGINT, length = 20,  isNull = true, comment = "子表对应ID")
