 ...
 */
@Data
@Table(value = "incloud_base_portal_content_adj_news",comment = "调整 新闻通告类内容发布")
@TableName("incloud_base_portal_content_adj_news")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "调整 新闻通告类内容发布 Entity")
public class PortalContentAdjNews extends WfEntity<PortalContentAdjNews> {
    ...
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "申请人名称")
