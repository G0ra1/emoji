 ...
 */
@Data
@Table(value = "incloud_base_portal_content_his_sysjoints_son",comment = "历史 系统集成类内容发布子表")
@TableName("incloud_base_portal_content_his_sysjoints_son")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "历史 系统集成类内容发布子表 Entity")
public class PortalContentHisSysjointsSon extends IModel<PortalContentHisSysjointsSon> {
