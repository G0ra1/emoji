 ...
 */
@Data
@Table(value = "incloud_base_wf_delegation_task",comment = "我委托的待办")
@TableName("incloud_base_wf_delegation_task")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "我委托的待办 Entity")
public class WfDelegationTask extends IModel<WfDelegationTask> {
    ...
    */
    ...
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "被委托人")
    ...
    */
    ...
    @Column(type = DataType.VARCHAR, length = 50,  isNull = true, comment = "被委托人名称")
    ...
    */
    ...
    @Column(type = DataType.VARCHAR, length = 32,  isNull = true, comment = "委托办理人")
    ...
    */
    ...
    @Column(type = DataType.VARCHAR, length = 50,  isNull = true, comment = "委托办理人")
