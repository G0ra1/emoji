 ...
 */
@Data
@Table(value = "incloud_base_wf_send_notify_task",comment = "我发出的知会")
@TableName("incloud_base_wf_send_notify_task")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "我发出的知会 Entity")
public class WfSendNotifyTask extends IModel<WfSendNotifyTask> {
    ...
    * 发起知会的任务节点类型
    */
    @ApiModelProperty(value="发起知会的任务节点类型")
    @TableField(value="camunda_node_type")
    @Column(type = DataType.INT, length = 10,  isNull = false, comment = "发起知会的任务节点类型")
