 ...
 */
@Data
@Table(value = "incloud_base_wf_my_out_duplicate_task",comment = "我发起的传阅")
@TableName("incloud_base_wf_my_out_duplicate_task")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "我发起的传阅 Entity")
public class WfMyOutDuplicateTask extends IModel<WfMyOutDuplicateTask> {
